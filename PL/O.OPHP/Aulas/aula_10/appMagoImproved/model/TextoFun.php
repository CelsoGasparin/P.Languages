...
class TextoFun{
    ...
    public function contemAcento($string){
        $qtdAc = 0;
        $iLen = strlen($string);
        $acentos = [
            'á','à','ã','â','Á','À','Ã','Â',
    ...
    public function validCharac($string){
    ...
    public function removerAcento(string $string){
        $iLen = strlen($string);
        $actualString = '';
        $acentos = [
            ['á','à','ã','â'],['Á','À','Ã','Â'],
    ...
    public function repeatCharac(string $string,$oi){
        $strLen = strlen($string);
        $strArray = [];
        $repeats = 0;
        for($i=0; $i < $strLen; $i++){ 
    ...
    public function removerEspacos(string $string){
        $strLen = strlen($string);
        $strArray = [];
        $actualString = null;
        for($i=0; $i < $strLen; $i++){ 
